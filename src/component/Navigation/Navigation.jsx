...
const Navigation = () => {
  return (
    ...
    <div className="container">
      <a className="navbar-brand" href="#page-top">Sefanya Luis Ering</a>
      ...
      <div className="collapse navbar-collapse" id="navbarResponsive">
        <ul className="navbar-nav ms-auto">
          ...
          <li className="nav-item mx-0 mx-lg-1"><a className="nav-link py-3 px-0 px-lg-3 rounded" href="#contact">Skills</a></li>
        </ul>
      </div>
    </div>
  </nav>
